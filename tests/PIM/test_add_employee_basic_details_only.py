...
class TestEmployeeAddition:
    ...
    def test_add_employee_basic_details_only(self, driver):
        ...
        print(f"✅ Employee created: {first_name} {last_name} (ID: {employee_id})")
